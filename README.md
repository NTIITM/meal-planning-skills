...
```powershell
git clone https://github.com/<your-user>/meal-planning-codex-skills.git
Copy-Item -Recurse .\meal-planning-codex-skills\skills\carb-cycle-batch-meal-planner "$env:USERPROFILE\.codex\skills\"
Copy-Item -Recurse .\meal-planning-codex-skills\skills\store-locked-grocery-planner "$env:USERPROFILE\.codex\skills\"
```
...
```bash
git clone https://github.com/<your-user>/meal-planning-codex-skills.git
cp -R meal-planning-codex-skills/skills/carb-cycle-batch-meal-planner ~/.codex/skills/
cp -R meal-planning-codex-skills/skills/store-locked-grocery-planner ~/.codex/skills/
```
